...
base_dir = 'C:\Users\ahmed\Downloads\ds000005_R2.0.0\ds005_R2.0.0\sub-01\func';
...
for k = 1:length(runs)
    ...
    tsv_file = fullfile(base_dir, sprintf('sub-01_task-mixedgamblestask_run-%s_events.tsv', run_num));
